...
public class WorkWithString {
    ...
    public String doubleToStr(double numDouble) {
        ...
        if (numDouble >= -999_999_999.999 && numDouble <= 999_999_999.999) {
            ...
            result = numDouble < 0 ? "минус " + numToStr((int)numDouble) + tmp + numToStr(desCast(numDouble, numAfterComma)) + " сотых" :
                                     "" + numToStr((int)numDouble) + tmp + numToStr(desCast(numDouble, numAfterComma)) + " сотых" ;
        } else {
            result = "введите другое число";
        }
